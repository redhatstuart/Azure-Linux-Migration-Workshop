...
echo "--BEGIN-- Provision Stage 3 Script at `date`" >>/root/lsprovision.log
echo "********************************************************************************************"
	echo "Populating Student Desktop at `date`" >>/root/lsprovision.log
...
echo "********************************************************************************************"
echo "--END-- Provision Stage 3 Script at `date`" >>/root/lsprovision.log
